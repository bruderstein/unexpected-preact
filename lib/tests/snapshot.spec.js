...
function renderIntoDocument(element) {
  ...
  return _preact2.default.render(element, container);
}
...
describe('snapshots', function () {
  ...
  it('passes a single test snapshot', function () {
    ...
    var renderer = renderIntoDocument((0, _preact.h)(_ClickCounter2.default, null));
  ...
  it('fails on a snapshot that doesn`t match', function () {
    ...
    }, 'to throw', ['expected', '<ClickCounter>', '  <button onClick={function bound onClick() { /* native code */ }}>', '    Clicked 1 times', '  </button>', '</ClickCounter>', "with event 'click' to match snapshot", '', '<button onClick={function bound onClick() { /* native code */ }}>', '  Clicked 1 times // -Clicked 1 times', '                  // +Clicked 0 times', '</button>'].join('\n'));
  });
  ...
  it('matches classes in the wrong order', function () {
    ...
    var renderer = renderIntoDocument((0, _preact.h)(_ClickCounter2.default, { className: 'three two one' }));
    expect(renderer, 'to match snapshot');
  });
  ...
  it('diffs missing classes', function () {
    ...
    var renderer = renderIntoDocument((0, _preact.h)(_ClickCounter2.default, { className: 'three one' }));
    expect(function () {
      return expect(renderer, 'to match snapshot');
    }, 'to throw', ['expected', '<ClickCounter class="three one">', '  <button onClick={function bound onClick() { /* native code */ }} class="three one">', '    Clicked 0 times', '  </button>', '</ClickCounter>', 'to match snapshot', '', '<button onClick={function bound onClick() { /* native code */ }}', '   class="three one" // missing class \'two\'', '>', '  Clicked 0 times', '</button>'].join('\n'));
  });
  ...
  it('diffs extra classes', function () {
    ...
    var renderer = renderIntoDocument((0, _preact.h)(_ClickCounter2.default, { className: 'three two one four' }));
    expect(function () {
      return expect(renderer, 'to match snapshot');
    }, 'to throw', ['expected', '<ClickCounter class="three two one four">', '  <button onClick={function bound onClick() { /* native code */ }}', '     class="three two one four">', '    Clicked 0 times', '  </button>', '</ClickCounter>', 'to match snapshot', '', '<button onClick={function bound onClick() { /* native code */ }}', '   class="three two one four" // extra class \'four\'', '>', '  Clicked 0 times', '</button>'].join('\n'));
  });
  ...
  it('diffs extra attributes', function () {
    ...
    var renderer = renderIntoDocument((0, _preact.h)(_ClickCounter2.default, { className: 'three two one', ariaLabel: 'testextra' }));
    expect(function () {
      return expect(renderer, 'to match snapshot');
    }, 'to throw', ['expected', '<ClickCounter ariaLabel="testextra" class="three two one">', '  <button onClick={function bound onClick() { /* native code */ }} ariaLabel="testextra"', '     class="three two one">', '    Clicked 0 times', '  </button>', '</ClickCounter>', 'to match snapshot', '', '<button onClick={function bound onClick() { /* native code */ }}', '   ariaLabel="testextra" // ariaLabel should be removed', '   class="three two one">', '  Clicked 0 times', '</button>'].join('\n'));
  });
  ...
  describe('with functions', function () {
    it('compares with a snapshot with a normal function', function () {
      ...
      var renderer = renderIntoDocument((0, _preact.h)(_ClickCounter2.default, { onMouseDown: _functions2.default.anonymous() }));
      expect(renderer, 'to match snapshot');
      ...
      renderer = renderIntoDocument((0, _preact.h)(_ClickCounter2.default, { onMouseDown: _functions2.default.anonymous() }));
      expect(renderer, 'to match snapshot');
    });
    ...
    it('compares with a snapshot with a bound function', function () {
      ...
      var renderer = renderIntoDocument((0, _preact.h)(_ClickCounter2.default, { onMouseDown: _functions2.default.boundContentArgs() }));
      expect(renderer, 'to match snapshot');
      ...
      renderer = renderIntoDocument((0, _preact.h)(_ClickCounter2.default, { onMouseDown: _functions2.default.boundContentArgs() }));
      expect(renderer, 'to match snapshot');
    });
    ...
    it('fails with a snapshot with a normal function when the expected is bound', function () {
      ...
      renderer = renderIntoDocument((0, _preact.h)(_ClickCounter2.default, { onMouseDown: _functions2.default.namedContentArgs() }));
      expect(function () {
        return expect(renderer, 'to match snapshot');
      }, 'to throw', ['expected', '<ClickCounter onMouseDown={function doStuff(a, b) { /* ... */ }}>', '  <button onClick={function bound onClick() { /* native code */ }}', '     onMouseDown={function doStuff(a, b) { /* ... */ }}>', '    Clicked 0 times', '  </button>', '</ClickCounter>', 'to match snapshot', '', '<button onClick={function bound onClick() { /* native code */ }}', '   onMouseDown={function doStuff(a, b) { /* ... */ }} // expected', '                                                      // function doStuff(a, b) {', '                                                      //   // comment', '                                                      //   return a + b;', '                                                      // }', '                                                      // to satisfy function bound bound3() { /* function body */ }', '                                                      //', '                                                      // -function doStuff(a, b) { /* function body */ }', '                                                      // +function bound bound3() { /* function body */ }', '>', '  Clicked 0 times', '</button>'].join('\n'));
    });
  });
